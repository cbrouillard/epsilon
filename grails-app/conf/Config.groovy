...
environments {
    ...
    test {
        grails.serverURL = props.get("epsilon.grails.server.url") //"http://localhost:8080/${appName}"
    }
...
log4j = {
    ...
    debug 'grails.app.task', 'com.headbangers.epsilon'
...
grails.mail.host = props.get("epsilon.grails.mail.host")
grails.mail.port = props.get("epsilon.grails.mail.port")
grails.mail.username = props.get("epsilon.grails.mail.username")
grails.mail.password = props.get("epsilon.grails.mail.password")
grails.mail.default.from=props.get("epsilon.grails.mail.default.from")
