...
<body>
<div class="col-sm-12">
    <h1>Liste des prêts <small>Prêts et emprunts</small> <g:link controller="loan" action="create" class="btn btn-success"><img
    ...
    <div class="around-border">
        ...
        <table class="table table-striped table-hover">
            ...
            <tr>
                ...
                <g:sortableColumn property="amount" title="${message(code: 'loan.amount.label', default: 'Amount')}" class="text-right"/>
                <g:sortableColumn property="interest"
                                  title="${message(code: 'loan.interest.label', default: 'Interest')}" class="text-right"/>
                <g:sortableColumn property="refundValue"
                                  title="${message(code: 'loan.refundValue.label', default: 'Refund')}" class="text-right"/>
                <g:sortableColumn property="currentCalculatedAmountValue"
                                  title="${message(code: 'loan.currentCalculatedAmountValue.label', default: 'Current')}" class="text-right"/>
            ...
            <g:each in="${loanInstanceList}" status="i" var="loanInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td class="text-right">
                        ...
                        <g:link title="Afficher l'échéance associée" class="popup" controller="scheduled" action="show"
