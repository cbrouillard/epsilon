    ...
    <g:form action="install" method="post">
            ...
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="adminpassword"><g:message code="setup.adminpass.label"
                                                              default="Admin password"/>:</label>
                    </td>
        ...
        <div class="dialog">
            ...
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="userRealName"><g:message code="person.userRealName.label"
                                                             default="UserRealName"/>:</label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="passwd"><g:message code="person.pass.label" default="Pass"/>:</label>
                    </td>
        ...
        <div class="buttons">
            <span class="button"><g:submitButton name="create" class="save"
                                                 value="${message(code: 'setup.button.install.label', default: 'Install')}"/></span>
        </div>
