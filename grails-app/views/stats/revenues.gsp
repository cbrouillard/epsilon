...
<!--          <span class="menuButton"><g:link class="stats" action="operations">Dépenses/mois</g:link></span>-->
        ...
        <div class="body">
            <h1>Graphe des dépenses pour les revenus</h1>
            <div class="help">Attention ! Ce graphique ne montre que les catégories de type "Dépôt"</div>
            <g:if test="${flash.message}">
            <div class="message">${flash.message}</div>
            </g:if>
            <div class="chart" id="opChart">
              <g:render template="/generic/chart"  model="[name:'OpChart', controller:'stats', action:'revenuesChart', forcedWidth:'700px']"/>
            </div>
        </div>
    </body>
</html>
